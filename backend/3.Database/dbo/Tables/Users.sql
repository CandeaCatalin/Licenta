...
(
	...
	CONSTRAINT [FK_Users_UserRoles] FOREIGN KEY ([UserRolesId]) REFERENCES [dbo].[UserRoles]([Id]),
...
GO
CREATE NONCLUSTERED INDEX [IX_Users_UserRolesId] ON [dbo].[Users]([UserRolesId]);
GO
