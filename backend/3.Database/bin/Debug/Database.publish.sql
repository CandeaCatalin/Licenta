...
GO
PRINT N'Creating Index [dbo].[PhysicalQueues].[IX_PhysicalQueues_Name_Description]...';


GO
CREATE NONCLUSTERED INDEX [IX_PhysicalQueues_Name_Description]
    ON [dbo].[PhysicalQueues]([Name] ASC, [Description] ASC);
...
GO
PRINT N'Creating Index [dbo].[Queues].[IX_Queues_Name_Description]...';


GO
CREATE NONCLUSTERED INDEX [IX_Queues_Name_Description]
    ON [dbo].[Queues]([Name] ASC, [Description] ASC);
